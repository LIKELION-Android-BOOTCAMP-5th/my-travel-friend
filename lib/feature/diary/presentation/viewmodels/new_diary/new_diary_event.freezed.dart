...
class ChangeCurrency implements NewDiaryEvent {
...
@override
String toString() {
  return 'NewDiaryEvent.changeCurrency(currency: $currency)';
}
...
/// @nodoc
abstract mixin class $ChangeCurrencyCopyWith<$Res> implements $NewDiaryEventCopyWith<$Res> {
