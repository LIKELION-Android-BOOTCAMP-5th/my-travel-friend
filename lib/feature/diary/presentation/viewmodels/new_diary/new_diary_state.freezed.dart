...
// 여행, 사용자 정보
 ...
 String get type; String get title; String get content; double get rating; String? get imgUrl; File? get localImgFile; int? get cost; String get currency; bool get isPublic; int? get scheduleId;// 일정 관련 (팝업용)
...
@override
int get hashCode => Object.hashAll([runtimeType,tripId,userId,type,title,content,rating,imgUrl,localImgFile,cost,currency,isPublic,scheduleId,const DeepCollectionEquality().hash(schedules),isLoadingSchedules,message,errorType,actionType,isUploading,pageState]);

@override
String toString() {
  return 'NewDiaryState(tripId: $tripId, userId: $userId, type: $type, title: $title, content: $content, rating: $rating, imgUrl: $imgUrl, localImgFile: $localImgFile, cost: $cost, currency: $currency, isPublic: $isPublic, scheduleId: $scheduleId, schedules: $schedules, isLoadingSchedules: $isLoadingSchedules, message: $message, errorType: $errorType, actionType: $actionType, isUploading: $isUploading, pageState: $pageState)';
}
...
@useResult
$Res call({
 int tripId, int userId, String type, String title, String content, double rating, String? imgUrl, File? localImgFile, int? cost, String currency, bool isPublic, int? scheduleId, List<ScheduleEntity> schedules, bool isLoadingSchedules, String? message, String? errorType, String? actionType, bool isUploading, NewDiaryPageState pageState
});
...
/// Create a copy of NewDiaryState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? tripId = null,Object? userId = null,Object? type = null,Object? title = null,Object? content = null,Object? rating = null,Object? imgUrl = freezed,Object? localImgFile = freezed,Object? cost = freezed,Object? currency = null,Object? isPublic = null,Object? scheduleId = freezed,Object? schedules = null,Object? isLoadingSchedules = null,Object? message = freezed,Object? errorType = freezed,Object? actionType = freezed,Object? isUploading = null,Object? pageState = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int tripId,  int userId,  String type,  String title,  String content,  double rating,  String? imgUrl,  File? localImgFile,  int? cost,  String currency,  bool isPublic,  int? scheduleId,  List<ScheduleEntity> schedules,  bool isLoadingSchedules,  String? message,  String? errorType,  String? actionType,  bool isUploading,  NewDiaryPageState pageState)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NewDiaryState() when $default != null:
return $default(_that.tripId,_that.userId,_that.type,_that.title,_that.content,_that.rating,_that.imgUrl,_that.localImgFile,_that.cost,_that.currency,_that.isPublic,_that.scheduleId,_that.schedules,_that.isLoadingSchedules,_that.message,_that.errorType,_that.actionType,_that.isUploading,_that.pageState);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int tripId,  int userId,  String type,  String title,  String content,  double rating,  String? imgUrl,  File? localImgFile,  int? cost,  String currency,  bool isPublic,  int? scheduleId,  List<ScheduleEntity> schedules,  bool isLoadingSchedules,  String? message,  String? errorType,  String? actionType,  bool isUploading,  NewDiaryPageState pageState)  $default,) {final _that = this;
switch (_that) {
case _NewDiaryState():
return $default(_that.tripId,_that.userId,_that.type,_that.title,_that.content,_that.rating,_that.imgUrl,_that.localImgFile,_that.cost,_that.currency,_that.isPublic,_that.scheduleId,_that.schedules,_that.isLoadingSchedules,_that.message,_that.errorType,_that.actionType,_that.isUploading,_that.pageState);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int tripId,  int userId,  String type,  String title,  String content,  double rating,  String? imgUrl,  File? localImgFile,  int? cost,  String currency,  bool isPublic,  int? scheduleId,  List<ScheduleEntity> schedules,  bool isLoadingSchedules,  String? message,  String? errorType,  String? actionType,  bool isUploading,  NewDiaryPageState pageState)?  $default,) {final _that = this;
switch (_that) {
case _NewDiaryState() when $default != null:
return $default(_that.tripId,_that.userId,_that.type,_that.title,_that.content,_that.rating,_that.imgUrl,_that.localImgFile,_that.cost,_that.currency,_that.isPublic,_that.scheduleId,_that.schedules,_that.isLoadingSchedules,_that.message,_that.errorType,_that.actionType,_that.isUploading,_that.pageState);case _:
  return null;
...
@override
int get hashCode => Object.hashAll([runtimeType,tripId,userId,type,title,content,rating,imgUrl,localImgFile,cost,currency,isPublic,scheduleId,const DeepCollectionEquality().hash(_schedules),isLoadingSchedules,message,errorType,actionType,isUploading,pageState]);
...
/// Create a copy of NewDiaryState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? tripId = null,Object? userId = null,Object? type = null,Object? title = null,Object? content = null,Object? rating = null,Object? imgUrl = freezed,Object? localImgFile = freezed,Object? cost = freezed,Object? currency = null,Object? isPublic = null,Object? scheduleId = freezed,Object? schedules = null,Object? isLoadingSchedules = null,Object? message = freezed,Object? errorType = freezed,Object? actionType = freezed,Object? isUploading = null,Object? pageState = null,}) {
