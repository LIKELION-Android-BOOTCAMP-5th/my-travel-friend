...
// 다이어리 ID (수정 대상)
 ...
 int? get cost; bool get isPublic; int? get scheduleId;// 수정된 다이어리
...
@override
int get hashCode => Object.hashAll([runtimeType,diaryId,tripId,userId,originalDiary,type,title,content,rating,imgUrl,localImgFile,cost,isPublic,scheduleId,updatedDiary,message,errorType,actionType,isUploading,pageState]);

@override
String toString() {
  return 'EditDiaryState(diaryId: $diaryId, tripId: $tripId, userId: $userId, originalDiary: $originalDiary, type: $type, title: $title, content: $content, rating: $rating, imgUrl: $imgUrl, localImgFile: $localImgFile, cost: $cost, isPublic: $isPublic, scheduleId: $scheduleId, updatedDiary: $updatedDiary, message: $message, errorType: $errorType, actionType: $actionType, isUploading: $isUploading, pageState: $pageState)';
}
...
@useResult
$Res call({
 int? diaryId, int tripId, int userId, DiaryEntity? originalDiary, String type, String title, String content, double rating, String? imgUrl, File? localImgFile, int? cost, bool isPublic, int? scheduleId, DiaryEntity? updatedDiary, String? message, String? errorType, String? actionType, bool isUploading, EditDiaryPageState pageState
});
...
/// Create a copy of EditDiaryState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? diaryId = freezed,Object? tripId = null,Object? userId = null,Object? originalDiary = freezed,Object? type = null,Object? title = null,Object? content = null,Object? rating = null,Object? imgUrl = freezed,Object? localImgFile = freezed,Object? cost = freezed,Object? isPublic = null,Object? scheduleId = freezed,Object? updatedDiary = freezed,Object? message = freezed,Object? errorType = freezed,Object? actionType = freezed,Object? isUploading = null,Object? pageState = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? diaryId,  int tripId,  int userId,  DiaryEntity? originalDiary,  String type,  String title,  String content,  double rating,  String? imgUrl,  File? localImgFile,  int? cost,  bool isPublic,  int? scheduleId,  DiaryEntity? updatedDiary,  String? message,  String? errorType,  String? actionType,  bool isUploading,  EditDiaryPageState pageState)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EditDiaryState() when $default != null:
return $default(_that.diaryId,_that.tripId,_that.userId,_that.originalDiary,_that.type,_that.title,_that.content,_that.rating,_that.imgUrl,_that.localImgFile,_that.cost,_that.isPublic,_that.scheduleId,_that.updatedDiary,_that.message,_that.errorType,_that.actionType,_that.isUploading,_that.pageState);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? diaryId,  int tripId,  int userId,  DiaryEntity? originalDiary,  String type,  String title,  String content,  double rating,  String? imgUrl,  File? localImgFile,  int? cost,  bool isPublic,  int? scheduleId,  DiaryEntity? updatedDiary,  String? message,  String? errorType,  String? actionType,  bool isUploading,  EditDiaryPageState pageState)  $default,) {final _that = this;
switch (_that) {
case _EditDiaryState():
return $default(_that.diaryId,_that.tripId,_that.userId,_that.originalDiary,_that.type,_that.title,_that.content,_that.rating,_that.imgUrl,_that.localImgFile,_that.cost,_that.isPublic,_that.scheduleId,_that.updatedDiary,_that.message,_that.errorType,_that.actionType,_that.isUploading,_that.pageState);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? diaryId,  int tripId,  int userId,  DiaryEntity? originalDiary,  String type,  String title,  String content,  double rating,  String? imgUrl,  File? localImgFile,  int? cost,  bool isPublic,  int? scheduleId,  DiaryEntity? updatedDiary,  String? message,  String? errorType,  String? actionType,  bool isUploading,  EditDiaryPageState pageState)?  $default,) {final _that = this;
switch (_that) {
case _EditDiaryState() when $default != null:
return $default(_that.diaryId,_that.tripId,_that.userId,_that.originalDiary,_that.type,_that.title,_that.content,_that.rating,_that.imgUrl,_that.localImgFile,_that.cost,_that.isPublic,_that.scheduleId,_that.updatedDiary,_that.message,_that.errorType,_that.actionType,_that.isUploading,_that.pageState);case _:
  return null;
