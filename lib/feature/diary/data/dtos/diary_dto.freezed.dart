...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,createdAt,tripId,userId,const DeepCollectionEquality().hash(userJson),isPublic,type,title,scheduleId,img,rating,content,cost,currency,payment);

@override
String toString() {
  return 'DiaryDTO(id: $id, createdAt: $createdAt, tripId: $tripId, userId: $userId, userJson: $userJson, isPublic: $isPublic, type: $type, title: $title, scheduleId: $scheduleId, img: $img, rating: $rating, content: $content, cost: $cost, currency: $currency, payment: $payment)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id, @JsonKey(name: 'created_at')  String? createdAt, @JsonKey(name: 'trip_id')  int tripId, @JsonKey(name: 'user_id')  int userId, @JsonKey(name: 'user')  Map<String, dynamic>? userJson, @JsonKey(name: 'is_public')  bool isPublic,  String type,  String? title, @JsonKey(name: 'schedule_id')  int? scheduleId,  String? img,  double? rating,  String? content,  int? cost,  String? currency,  String? payment)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DiaryDTO() when $default != null:
return $default(_that.id,_that.createdAt,_that.tripId,_that.userId,_that.userJson,_that.isPublic,_that.type,_that.title,_that.scheduleId,_that.img,_that.rating,_that.content,_that.cost,_that.currency,_that.payment);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,createdAt,tripId,userId,const DeepCollectionEquality().hash(_userJson),isPublic,type,title,scheduleId,img,rating,content,cost,currency,payment);
