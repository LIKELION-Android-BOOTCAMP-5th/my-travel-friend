...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,entireAlarm,tripRequest,newFriend,friendRequest,scheduleEdited,scheduleAdded,scheduleDeleted,talkMessage,dDay,userId);

@override
String toString() {
  return 'AlarmSettingDTO(id: $id, entireAlarm: $entireAlarm, tripRequest: $tripRequest, newFriend: $newFriend, friendRequest: $friendRequest, scheduleEdited: $scheduleEdited, scheduleAdded: $scheduleAdded, scheduleDeleted: $scheduleDeleted, talkMessage: $talkMessage, dDay: $dDay, userId: $userId)';
}
...
@useResult
$Res call({
 int id,@JsonKey(name: 'entire_alarm') bool entireAlarm,@JsonKey(name: 'trip_request') bool tripRequest,@JsonKey(name: 'new_friend') bool newFriend,@JsonKey(name: 'friend_request') bool friendRequest,@JsonKey(name: 'schedule_edited') bool scheduleEdited,@JsonKey(name: 'schedule_added') bool scheduleAdded,@JsonKey(name: 'schedule_deleted') bool scheduleDeleted,@JsonKey(name: 'talk_message') bool talkMessage,@JsonKey(name: 'd-day') bool dDay,@JsonKey(name: 'user_id') int userId
});
...
/// Create a copy of AlarmSettingDTO
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? entireAlarm = null,Object? tripRequest = null,Object? newFriend = null,Object? friendRequest = null,Object? scheduleEdited = null,Object? scheduleAdded = null,Object? scheduleDeleted = null,Object? talkMessage = null,Object? dDay = null,Object? userId = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'entire_alarm')  bool entireAlarm, @JsonKey(name: 'trip_request')  bool tripRequest, @JsonKey(name: 'new_friend')  bool newFriend, @JsonKey(name: 'friend_request')  bool friendRequest, @JsonKey(name: 'schedule_edited')  bool scheduleEdited, @JsonKey(name: 'schedule_added')  bool scheduleAdded, @JsonKey(name: 'schedule_deleted')  bool scheduleDeleted, @JsonKey(name: 'talk_message')  bool talkMessage, @JsonKey(name: 'd-day')  bool dDay, @JsonKey(name: 'user_id')  int userId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AlarmSettingDTO() when $default != null:
return $default(_that.id,_that.entireAlarm,_that.tripRequest,_that.newFriend,_that.friendRequest,_that.scheduleEdited,_that.scheduleAdded,_that.scheduleDeleted,_that.talkMessage,_that.dDay,_that.userId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'entire_alarm')  bool entireAlarm, @JsonKey(name: 'trip_request')  bool tripRequest, @JsonKey(name: 'new_friend')  bool newFriend, @JsonKey(name: 'friend_request')  bool friendRequest, @JsonKey(name: 'schedule_edited')  bool scheduleEdited, @JsonKey(name: 'schedule_added')  bool scheduleAdded, @JsonKey(name: 'schedule_deleted')  bool scheduleDeleted, @JsonKey(name: 'talk_message')  bool talkMessage, @JsonKey(name: 'd-day')  bool dDay, @JsonKey(name: 'user_id')  int userId)  $default,) {final _that = this;
switch (_that) {
case _AlarmSettingDTO():
return $default(_that.id,_that.entireAlarm,_that.tripRequest,_that.newFriend,_that.friendRequest,_that.scheduleEdited,_that.scheduleAdded,_that.scheduleDeleted,_that.talkMessage,_that.dDay,_that.userId);case _:
  throw StateError('Unexpected subclass');
...
class _AlarmSettingDTO extends AlarmSettingDTO {
  const _AlarmSettingDTO({required this.id, @JsonKey(name: 'entire_alarm') required this.entireAlarm, @JsonKey(name: 'trip_request') required this.tripRequest, @JsonKey(name: 'new_friend') required this.newFriend, @JsonKey(name: 'friend_request') required this.friendRequest, @JsonKey(name: 'schedule_edited') required this.scheduleEdited, @JsonKey(name: 'schedule_added') required this.scheduleAdded, @JsonKey(name: 'schedule_deleted') required this.scheduleDeleted, @JsonKey(name: 'talk_message') required this.talkMessage, @JsonKey(name: 'd-day') required this.dDay, @JsonKey(name: 'user_id') required this.userId}): super._();
...
@override@JsonKey(name: 'new_friend') final  bool newFriend;
...
/// Create a copy of AlarmSettingDTO
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? entireAlarm = null,Object? tripRequest = null,Object? newFriend = null,Object? friendRequest = null,Object? scheduleEdited = null,Object? scheduleAdded = null,Object? scheduleDeleted = null,Object? talkMessage = null,Object? dDay = null,Object? userId = null,}) {
