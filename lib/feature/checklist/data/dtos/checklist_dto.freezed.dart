...
class _ChecklistDTO extends ChecklistDTO {
  const _ChecklistDTO({this.id, @JsonKey(name: 'trip_id') required this.tripId, @JsonKey(name: 'user_id') required this.userId, required this.content, @JsonKey(name: 'is_checked') required this.isChecked}): super._();
