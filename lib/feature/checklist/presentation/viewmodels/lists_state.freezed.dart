...
// 개별 토글 상태 관리 (수정됨)
 final  Set<int> _togglingChecklistIds;
// 개별 토글 상태 관리 (수정됨)
@override@JsonKey() Set<int> get togglingChecklistIds {
  if (_togglingChecklistIds is EqualUnmodifiableSetView) return _togglingChecklistIds;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableSetView(_togglingChecklistIds);
}

 final  Set<int> _togglingTodoIds;
@override@JsonKey() Set<int> get togglingTodoIds {
  if (_togglingTodoIds is EqualUnmodifiableSetView) return _togglingTodoIds;
  // ignore: implicit_dynamic_type
