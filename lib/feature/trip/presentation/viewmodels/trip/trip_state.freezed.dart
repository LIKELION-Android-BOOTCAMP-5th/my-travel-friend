...
//조회정보
 ...
 TripPageState get pageState; bool get hasMore; bool get isLoadingMore;// 네비게이션 (작성 화면 이동)
...
@override
int get hashCode => Object.hash(runtimeType,selectedTrip,const DeepCollectionEquality().hash(trips),const DeepCollectionEquality().hash(searchTrips),userSearch,search,sorting,currentPage,pageState,hasMore,isLoadingMore,navigateToCreate,navigateToEdit,message,errorType,actionType);

@override
String toString() {
  return 'TripState(selectedTrip: $selectedTrip, trips: $trips, searchTrips: $searchTrips, userSearch: $userSearch, search: $search, sorting: $sorting, currentPage: $currentPage, pageState: $pageState, hasMore: $hasMore, isLoadingMore: $isLoadingMore, navigateToCreate: $navigateToCreate, navigateToEdit: $navigateToEdit, message: $message, errorType: $errorType, actionType: $actionType)';
}
...
@useResult
$Res call({
 TripEntity? selectedTrip, List<TripEntity>? trips, List<TripEntity>? searchTrips, String? userSearch, bool search, SortingTrip sorting, int currentPage, TripPageState pageState, bool hasMore, bool isLoadingMore, bool navigateToCreate, bool navigateToEdit, String? message, String? errorType, String? actionType
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TripEntity? selectedTrip,  List<TripEntity>? trips,  List<TripEntity>? searchTrips,  String? userSearch,  bool search,  SortingTrip sorting,  int currentPage,  TripPageState pageState,  bool hasMore,  bool isLoadingMore,  bool navigateToCreate,  bool navigateToEdit,  String? message,  String? errorType,  String? actionType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TripState() when $default != null:
return $default(_that.selectedTrip,_that.trips,_that.searchTrips,_that.userSearch,_that.search,_that.sorting,_that.currentPage,_that.pageState,_that.hasMore,_that.isLoadingMore,_that.navigateToCreate,_that.navigateToEdit,_that.message,_that.errorType,_that.actionType);case _:
  return orElse();
...
@override
int get hashCode => Object.hash(runtimeType,selectedTrip,const DeepCollectionEquality().hash(_trips),const DeepCollectionEquality().hash(_searchTrips),userSearch,search,sorting,currentPage,pageState,hasMore,isLoadingMore,navigateToCreate,navigateToEdit,message,errorType,actionType);
