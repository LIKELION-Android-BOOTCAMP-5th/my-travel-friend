...
//조회정보
 ...
 TripPageState get pageState; bool get hasMore; bool get isLoadingMore;//여행 상태별 분류
// 진행중인 여행 (start <= today <= end)
 List<TripEntity> get ongoingTrips;// 예정된 여행 (start > today)
 List<TripEntity> get upcomingTrips;// 종료된 여행 (end < today)
 List<TripEntity> get finishedTrips;//예정 여행 정렬
 SortingTrip get upcomingSorting;//종료 여행 정렬
 SortingTrip get finishedSorting;// 네비게이션 (작성 화면 이동)
 bool get navigateToCreate;// 네비게이션 (수정 화면 이동)
 bool get navigateToEdit;// 메세지 (성공/에러)
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TripState&&(identical(other.selectedTrip, selectedTrip) || other.selectedTrip == selectedTrip)&&const DeepCollectionEquality().equals(other.trips, trips)&&const DeepCollectionEquality().equals(other.searchTrips, searchTrips)&&(identical(other.userSearch, userSearch) || other.userSearch == userSearch)&&(identical(other.search, search) || other.search == search)&&(identical(other.sorting, sorting) || other.sorting == sorting)&&(identical(other.currentPage, currentPage) || other.currentPage == currentPage)&&(identical(other.pageState, pageState) || other.pageState == pageState)&&(identical(other.hasMore, hasMore) || other.hasMore == hasMore)&&(identical(other.isLoadingMore, isLoadingMore) || other.isLoadingMore == isLoadingMore)&&const DeepCollectionEquality().equals(other.ongoingTrips, ongoingTrips)&&const DeepCollectionEquality().equals(other.upcomingTrips, upcomingTrips)&&const DeepCollectionEquality().equals(other.finishedTrips, finishedTrips)&&(identical(other.upcomingSorting, upcomingSorting) || other.upcomingSorting == upcomingSorting)&&(identical(other.finishedSorting, finishedSorting) || other.finishedSorting == finishedSorting)&&(identical(other.navigateToCreate, navigateToCreate) || other.navigateToCreate == navigateToCreate)&&(identical(other.navigateToEdit, navigateToEdit) || other.navigateToEdit == navigateToEdit)&&(identical(other.message, message) || other.message == message)&&(identical(other.errorType, errorType) || other.errorType == errorType)&&(identical(other.actionType, actionType) || other.actionType == actionType));
}


@override
int get hashCode => Object.hashAll([runtimeType,selectedTrip,const DeepCollectionEquality().hash(trips),const DeepCollectionEquality().hash(searchTrips),userSearch,search,sorting,currentPage,pageState,hasMore,isLoadingMore,const DeepCollectionEquality().hash(ongoingTrips),const DeepCollectionEquality().hash(upcomingTrips),const DeepCollectionEquality().hash(finishedTrips),upcomingSorting,finishedSorting,navigateToCreate,navigateToEdit,message,errorType,actionType]);

@override
String toString() {
  return 'TripState(selectedTrip: $selectedTrip, trips: $trips, searchTrips: $searchTrips, userSearch: $userSearch, search: $search, sorting: $sorting, currentPage: $currentPage, pageState: $pageState, hasMore: $hasMore, isLoadingMore: $isLoadingMore, ongoingTrips: $ongoingTrips, upcomingTrips: $upcomingTrips, finishedTrips: $finishedTrips, upcomingSorting: $upcomingSorting, finishedSorting: $finishedSorting, navigateToCreate: $navigateToCreate, navigateToEdit: $navigateToEdit, message: $message, errorType: $errorType, actionType: $actionType)';
}
...
@useResult
$Res call({
 TripEntity? selectedTrip, List<TripEntity>? trips, List<TripEntity>? searchTrips, String? userSearch, bool search, SortingTrip sorting, int currentPage, TripPageState pageState, bool hasMore, bool isLoadingMore, List<TripEntity> ongoingTrips, List<TripEntity> upcomingTrips, List<TripEntity> finishedTrips, SortingTrip upcomingSorting, SortingTrip finishedSorting, bool navigateToCreate, bool navigateToEdit, String? message, String? errorType, String? actionType
});
...
as bool,ongoingTrips: null == ongoingTrips ? _self.ongoingTrips : ongoingTrips // ignore: cast_nullable_to_non_nullable
as List<TripEntity>,upcomingTrips: null == upcomingTrips ? _self.upcomingTrips : upcomingTrips // ignore: cast_nullable_to_non_nullable
as List<TripEntity>,finishedTrips: null == finishedTrips ? _self.finishedTrips : finishedTrips // ignore: cast_nullable_to_non_nullable
as List<TripEntity>,upcomingSorting: null == upcomingSorting ? _self.upcomingSorting : upcomingSorting // ignore: cast_nullable_to_non_nullable
as SortingTrip,finishedSorting: null == finishedSorting ? _self.finishedSorting : finishedSorting // ignore: cast_nullable_to_non_nullable
as SortingTrip,navigateToCreate: null == navigateToCreate ? _self.navigateToCreate : navigateToCreate // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TripEntity? selectedTrip,  List<TripEntity>? trips,  List<TripEntity>? searchTrips,  String? userSearch,  bool search,  SortingTrip sorting,  int currentPage,  TripPageState pageState,  bool hasMore,  bool isLoadingMore,  List<TripEntity> ongoingTrips,  List<TripEntity> upcomingTrips,  List<TripEntity> finishedTrips,  SortingTrip upcomingSorting,  SortingTrip finishedSorting,  bool navigateToCreate,  bool navigateToEdit,  String? message,  String? errorType,  String? actionType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TripState() when $default != null:
return $default(_that.selectedTrip,_that.trips,_that.searchTrips,_that.userSearch,_that.search,_that.sorting,_that.currentPage,_that.pageState,_that.hasMore,_that.isLoadingMore,_that.ongoingTrips,_that.upcomingTrips,_that.finishedTrips,_that.upcomingSorting,_that.finishedSorting,_that.navigateToCreate,_that.navigateToEdit,_that.message,_that.errorType,_that.actionType);case _:
  return orElse();
...
class _TripState implements TripState {
  const _TripState({this.selectedTrip, required final  List<TripEntity>? trips, final  List<TripEntity>? searchTrips, this.userSearch, this.search = false, this.sorting = SortingTrip.recent, this.currentPage = 1, this.pageState = TripPageState.init, this.hasMore = false, this.isLoadingMore = false, final  List<TripEntity> ongoingTrips = const [], final  List<TripEntity> upcomingTrips = const [], final  List<TripEntity> finishedTrips = const [], this.upcomingSorting = SortingTrip.recent, this.finishedSorting = SortingTrip.recent, this.navigateToCreate = false, this.navigateToEdit = false, this.message, this.errorType, this.actionType}): _trips = trips,_searchTrips = searchTrips,_ongoingTrips = ongoingTrips,_upcomingTrips = upcomingTrips,_finishedTrips = finishedTrips;
...
//여행 상태별 분류
// 진행중인 여행 (start <= today <= end)
 final  List<TripEntity> _ongoingTrips;
//여행 상태별 분류
// 진행중인 여행 (start <= today <= end)
@override@JsonKey() List<TripEntity> get ongoingTrips {
...
// 예정된 여행 (start > today)
 final  List<TripEntity> _upcomingTrips;
// 예정된 여행 (start > today)
@override@JsonKey() List<TripEntity> get upcomingTrips {
...
// 종료된 여행 (end < today)
 final  List<TripEntity> _finishedTrips;
// 종료된 여행 (end < today)
@override@JsonKey() List<TripEntity> get finishedTrips {
  if (_finishedTrips is EqualUnmodifiableListView) return _finishedTrips;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_finishedTrips);
}

//예정 여행 정렬
@override@JsonKey() final  SortingTrip upcomingSorting;
//종료 여행 정렬
@override@JsonKey() final  SortingTrip finishedSorting;
// 네비게이션 (작성 화면 이동)
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TripState&&(identical(other.selectedTrip, selectedTrip) || other.selectedTrip == selectedTrip)&&const DeepCollectionEquality().equals(other._trips, _trips)&&const DeepCollectionEquality().equals(other._searchTrips, _searchTrips)&&(identical(other.userSearch, userSearch) || other.userSearch == userSearch)&&(identical(other.search, search) || other.search == search)&&(identical(other.sorting, sorting) || other.sorting == sorting)&&(identical(other.currentPage, currentPage) || other.currentPage == currentPage)&&(identical(other.pageState, pageState) || other.pageState == pageState)&&(identical(other.hasMore, hasMore) || other.hasMore == hasMore)&&(identical(other.isLoadingMore, isLoadingMore) || other.isLoadingMore == isLoadingMore)&&const DeepCollectionEquality().equals(other._ongoingTrips, _ongoingTrips)&&const DeepCollectionEquality().equals(other._upcomingTrips, _upcomingTrips)&&const DeepCollectionEquality().equals(other._finishedTrips, _finishedTrips)&&(identical(other.upcomingSorting, upcomingSorting) || other.upcomingSorting == upcomingSorting)&&(identical(other.finishedSorting, finishedSorting) || other.finishedSorting == finishedSorting)&&(identical(other.navigateToCreate, navigateToCreate) || other.navigateToCreate == navigateToCreate)&&(identical(other.navigateToEdit, navigateToEdit) || other.navigateToEdit == navigateToEdit)&&(identical(other.message, message) || other.message == message)&&(identical(other.errorType, errorType) || other.errorType == errorType)&&(identical(other.actionType, actionType) || other.actionType == actionType));
}


@override
int get hashCode => Object.hashAll([runtimeType,selectedTrip,const DeepCollectionEquality().hash(_trips),const DeepCollectionEquality().hash(_searchTrips),userSearch,search,sorting,currentPage,pageState,hasMore,isLoadingMore,const DeepCollectionEquality().hash(_ongoingTrips),const DeepCollectionEquality().hash(_upcomingTrips),const DeepCollectionEquality().hash(_finishedTrips),upcomingSorting,finishedSorting,navigateToCreate,navigateToEdit,message,errorType,actionType]);
...
as TripPageState,hasMore: null == hasMore ? _self.hasMore : hasMore // ignore: cast_nullable_to_non_nullable
as bool,isLoadingMore: null == isLoadingMore ? _self.isLoadingMore : isLoadingMore // ignore: cast_nullable_to_non_nullable
as bool,ongoingTrips: null == ongoingTrips ? _self._ongoingTrips : ongoingTrips // ignore: cast_nullable_to_non_nullable
as List<TripEntity>,upcomingTrips: null == upcomingTrips ? _self._upcomingTrips : upcomingTrips // ignore: cast_nullable_to_non_nullable
as List<TripEntity>,finishedTrips: null == finishedTrips ? _self._finishedTrips : finishedTrips // ignore: cast_nullable_to_non_nullable
as List<TripEntity>,upcomingSorting: null == upcomingSorting ? _self.upcomingSorting : upcomingSorting // ignore: cast_nullable_to_non_nullable
as SortingTrip,finishedSorting: null == finishedSorting ? _self.finishedSorting : finishedSorting // ignore: cast_nullable_to_non_nullable
as SortingTrip,navigateToCreate: null == navigateToCreate ? _self.navigateToCreate : navigateToCreate // ignore: cast_nullable_to_non_nullable
as bool,navigateToEdit: null == navigateToEdit ? _self.navigateToEdit : navigateToEdit // ignore: cast_nullable_to_non_nullable
