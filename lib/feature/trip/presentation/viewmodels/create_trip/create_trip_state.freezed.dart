...
mixin _$CreateTripState {
 ...
 int get userId; String get title; String get place; String get startAt; String get endAt; String get coverType; String get country; String get coverStyle; String? get coverImg; File? get localImgFile; TripEntity? get createTrip; int? get friendId;// 메세지 (성공/에러)
...
@override
int get hashCode => Object.hashAll([runtimeType,userId,title,place,startAt,endAt,coverType,country,coverStyle,coverImg,localImgFile,createTrip,friendId,message,errorType,actionType,isSameDay,showSameDayDialog,isUploading,pageState]);

@override
String toString() {
  return 'CreateTripState(userId: $userId, title: $title, place: $place, startAt: $startAt, endAt: $endAt, coverType: $coverType, country: $country, coverStyle: $coverStyle, coverImg: $coverImg, localImgFile: $localImgFile, createTrip: $createTrip, friendId: $friendId, message: $message, errorType: $errorType, actionType: $actionType, isSameDay: $isSameDay, showSameDayDialog: $showSameDayDialog, isUploading: $isUploading, pageState: $pageState)';
}
...
@useResult
$Res call({
 int userId, String title, String place, String startAt, String endAt, String coverType, String country, String coverStyle, String? coverImg, File? localImgFile, TripEntity? createTrip, int? friendId, String? message, String? errorType, String? actionType, bool isSameDay, bool showSameDayDialog, bool isUploading, CreateTripPageState pageState
});
...
/// Create a copy of CreateTripState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? title = null,Object? place = null,Object? startAt = null,Object? endAt = null,Object? coverType = null,Object? country = null,Object? coverStyle = null,Object? coverImg = freezed,Object? localImgFile = freezed,Object? createTrip = freezed,Object? friendId = freezed,Object? message = freezed,Object? errorType = freezed,Object? actionType = freezed,Object? isSameDay = null,Object? showSameDayDialog = null,Object? isUploading = null,Object? pageState = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int userId,  String title,  String place,  String startAt,  String endAt,  String coverType,  String country,  String coverStyle,  String? coverImg,  File? localImgFile,  TripEntity? createTrip,  int? friendId,  String? message,  String? errorType,  String? actionType,  bool isSameDay,  bool showSameDayDialog,  bool isUploading,  CreateTripPageState pageState)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateTripState() when $default != null:
return $default(_that.userId,_that.title,_that.place,_that.startAt,_that.endAt,_that.coverType,_that.country,_that.coverStyle,_that.coverImg,_that.localImgFile,_that.createTrip,_that.friendId,_that.message,_that.errorType,_that.actionType,_that.isSameDay,_that.showSameDayDialog,_that.isUploading,_that.pageState);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int userId,  String title,  String place,  String startAt,  String endAt,  String coverType,  String country,  String coverStyle,  String? coverImg,  File? localImgFile,  TripEntity? createTrip,  int? friendId,  String? message,  String? errorType,  String? actionType,  bool isSameDay,  bool showSameDayDialog,  bool isUploading,  CreateTripPageState pageState)  $default,) {final _that = this;
switch (_that) {
case _CreateTripState():
return $default(_that.userId,_that.title,_that.place,_that.startAt,_that.endAt,_that.coverType,_that.country,_that.coverStyle,_that.coverImg,_that.localImgFile,_that.createTrip,_that.friendId,_that.message,_that.errorType,_that.actionType,_that.isSameDay,_that.showSameDayDialog,_that.isUploading,_that.pageState);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int userId,  String title,  String place,  String startAt,  String endAt,  String coverType,  String country,  String coverStyle,  String? coverImg,  File? localImgFile,  TripEntity? createTrip,  int? friendId,  String? message,  String? errorType,  String? actionType,  bool isSameDay,  bool showSameDayDialog,  bool isUploading,  CreateTripPageState pageState)?  $default,) {final _that = this;
switch (_that) {
case _CreateTripState() when $default != null:
return $default(_that.userId,_that.title,_that.place,_that.startAt,_that.endAt,_that.coverType,_that.country,_that.coverStyle,_that.coverImg,_that.localImgFile,_that.createTrip,_that.friendId,_that.message,_that.errorType,_that.actionType,_that.isSameDay,_that.showSameDayDialog,_that.isUploading,_that.pageState);case _:
  return null;
...
@override $TripEntityCopyWith<$Res>? get createTrip;
