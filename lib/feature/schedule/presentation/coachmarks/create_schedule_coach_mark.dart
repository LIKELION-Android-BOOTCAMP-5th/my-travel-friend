...
class CreateScheduleCoachMark {
  ...
  final GlobalKey dateTimeKey = GlobalKey();
  final GlobalKey placeKey = GlobalKey();
  final GlobalKey categoryKey = GlobalKey();
  final GlobalKey memberKey = GlobalKey();
  final GlobalKey saveButtonKey = GlobalKey();

  CreateScheduleCoachMark({CoachMarkService? coachMarkService})
    : _coachMarkService =
  ...
  void show(BuildContext context, {ScrollController? scrollController}) {
    ...
    _coachMarkService.showCoachMark(
      context: context,
      targets: targets,
      onFinish: () => _coachMarkService.completeCreateScheduleCoachMark(),
      onSkip: () => _coachMarkService.completeCreateScheduleCoachMark(),
    );
  }
}
